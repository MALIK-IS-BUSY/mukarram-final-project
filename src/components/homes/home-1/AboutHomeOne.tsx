          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 block-column">
              <div className="right-content">
                ...
                <p>Lumara, Consumers today rely heavily on digital means to research products. We research a brand of blend engaging with it, according to the meanwhile, 60% of consumers.</p>
